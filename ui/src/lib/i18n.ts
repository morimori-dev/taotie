...
const DICT: Record<string, Partial<Record<Locale, string>>> = {
  ...
  'ptree.detail.rules': { ja: '検知ルール', en: 'Detections' },
  'ptree.detail.parent': { ja: '親プロセス', en: 'Parent process' },
  'ptree.children': { ja: '子プロセス数', en: 'Child processes' },
  'ptree.danger_only': { ja: '危険な系譜のみ', en: 'Notable branches only' },
  'ptree.copy_chain': { ja: '系譜をコピー', en: 'Copy ancestry' },
  'ptree.other_instances': { ja: '同名/同ハッシュの他インスタンス', en: 'Other instances (same name/hash)' },
  'ptree.timeline_context': { ja: '前後のイベント', en: 'Surrounding events' },
  'ptree.related_activity': { ja: '関連アクティビティ (同一プロセス)', en: 'Related activity (same process)' },
  'ptree.related_none': { ja: 'このプロセスに紐づく他イベントはありません', en: 'No other events attributed to this process' },
  'ptree.related_loading': { ja: '読み込み中…', en: 'Loading…' },
  'ptree.copy': { ja: 'コピー', en: 'Copy' },
  'ptree.copied': { ja: 'コピー済', en: 'Copied' },
  'ptree.view_events': { ja: 'イベント一覧で確認', en: 'View in event list' },
